...
- Troubleshoot Azure production issues that are not Azure Local infrastructure, Azure Local VM, Azure Local resource bridge, or Azure Local SDN/update/upgrade issues
...
7. Route Azure Local infrastructure, Azure Local resource bridge, SDN, update/upgrade, and Azure Local VM issues to `azure-local`
...
| **Azure Local** | Deployment, Azure Local resource bridge, SDN, Azure Local VMs, updates/upgrades | `azure-local` Troubleshooting |
...
- Route Azure Local infrastructure, Azure Local resource bridge, SDN, updates/upgrades, and Azure Local VM issues to `azure-local` Troubleshooting.
